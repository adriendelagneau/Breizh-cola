...
const GalleryImg = () => {
    ...
    return (
        ...
        <div ref={plane1} className="absolute w-full h-screen">
            <div className="absolute h-[300px] w-[200px] top-[5%] left-[8%] ">
                <Image
            ...
            <div className="absolute h-[300px] w-[200px] top-[55%] left-[12%]">
                <Image
            ...
            <div className="absolute h-[300px] w-[200px] top-[35%] left-[70%] ">
                <Image
        ...
        <div ref={plane2} className="absolute top-0 left-0 w-full h-screen">
            <div className="absolute h-[300px] w-[200px] top-[10%] left-[28%] ">
                <Image
            ...
            <div className="absolute h-[300px] w-[200px] top-[50%] left-[50%] ">
                <Image
            ...
            <div className="absolute h-[200px] w-[300px] top-[8%] left-[75%] ">
                <Image
        ...
        <div ref={plane3} className="absolute top-0 left-0 w-full h-screen">
            <div className="absolute h-[180px] w-[180px] top-[15%] left-[50%]">
                <Image
            ...
            <div className="absolute h-[250px] w-[250px] top-[62%] left-[34%] ">
                <Image
            ...
            <div className="absolute h-[220px] w-[220px] top-[50%] left-[85%] ">
                <Image
