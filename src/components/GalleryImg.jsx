    ...
    return (
        <main onMouseMove={manageMouseMove} className="relative w-full h-screen overflow-hidden">
            ...
            <div ref={plane1} className="absolute w-full h-screen">
                <div className="absolute h-[150px] w-[100px] top-[5%] left-[8%] overflow-hidden filter brightness-80">
                    <Image
                ...
                <div className="absolute h-[150px] w-[100px] top-[55%] left-[12%] overflow-hidden">
                    <Image
                ...
                <div className="absolute h-[150px] w-[100px] top-[35%] left-[70%] overflow-hidden">
                    <Image
                        src={"/image/01.jpg"}
                        alt="image"
                        fill
            ...
            <div ref={plane2} className="absolute top-0 left-0 w-full h-screen">
                <div className="absolute h-[150px] w-[100px] top-[10%] left-[28%] overflow-hidden">
                    <Image
                ...
                <div className="absolute h-[150px] w-[100px] top-[50%] left-[50%] overflow-hidden">
                    <Image
                ...
                <div className="absolute h-[100px] w-[150px] top-[8%] left-[75%] overflow-hidden">
                    <Image
                        src={"/image/meme.jpg"}
                        alt="image"
                        fill
            ...
            <div ref={plane3} className="absolute top-0 left-0 w-full h-screen">
                <div className="absolute h-[100px] w-[100px] top-[15%] left-[50%] overflow-hidden filter brightness-90">
                    <Image
                        src={"/image/02.png"}
                        alt="image"
                        fill
                ...
                <div className="absolute h-[100px] w-[100px] top-[62%] left-[34%] overflow-hidden">
                    <Image
                        src={"/image/03.png"}
                        alt="image"
                        fill
                ...
                <div className="absolute h-[80px] w-[80px] top-[50%] left-[85%] overflow-hidden">
                    <Image
                        src={"/image/04.jpg"}
                        alt="image"
                        fill
