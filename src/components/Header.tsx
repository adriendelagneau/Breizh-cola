...
const Header = () => {
  ...
  return (
    <nav
      ref={navbarRef}
      className="bg-secondary text-primary font-poppins fixed top-0 left-0 z-50 flex h-20 w-full justify-between p-3 md:p-4"
    >
      <div className="flex items-center font-bold uppercase sm:text-xl">
        ...
        >
          <span
            className={`bg-primary absolute h-0.5 w-6 transition-all duration-300 ${
              isMenuOpen ? "rotate-45" : "-translate-y-2"
            }`}
          />
          <span
            className={`bg-primary absolute h-0.5 w-6 transition-opacity duration-300 ${
