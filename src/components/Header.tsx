...
const Header = () => {
  ...
  return (
    <nav
      ref={navbarRef}
      className="fixed left-0 z-50 flex justify-between w-full h-20 p-3 -top-full bg-secondary text-primary md:p-4 font-poppins "
    >
      ...
      <div className="absolute text-5xl capitalize -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 font-cream-cake md:text-6xl">
