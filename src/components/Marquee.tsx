...
const Marquee = ({ initialDirection = 1, speed = 1, sentence, bgColor = "#591420" }: MarqueeProps) => {
  ...
  return (
<div  style={{backgroundColor: bgColor}} className="text-mainColor border-2 border-mainColor"> 

    <div className={'relative flex h-[18vh] sm:h-[20vh] lg:h-[150px] w-full overflow-hidden'}>
      <div className="absolute z-10 -translate-x-3   top-1/2  -translate-y-1/2 ">
        <div
          ref={slider}
          className="relative text-6xl capitalize whitespace-nowrap font-poppins sm:text-7xl lg:text-8xl "
          >
