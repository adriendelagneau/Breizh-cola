...
{/* <BreizhCherry /> */}
      ...
      >
        <MagneticButtons>
          ...
          <TransitionLink href={"/products/breizh-cola-cherry"} label={"decouvrez le"}/>
          </button>
        </MagneticButtons>
      </div>
      ...
      <div className="flex flex-col gap-12 ml-3 text-3xl uppercase sm:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-poppins">
        <p className="flex gap-4 overflow-hidden">
          <span ref={ref1} className="translate-y-full opacity-0 text-mainColor dark:text-secondColor">
            notes
          </span>
          <span ref={ref2} className="overflow-hidden translate-y-full opacity-0 text-stroke-1 text-stroke-mainColor text-secondColor dark:text-mainColor dark:text-stroke-secondColor">
            gourmande
          </span>
        </p>
        <p className="flex gap-1 overflow-hidden">
          <span ref={ref3} className="translate-y-full opacity-0 text-stroke-1 text-stroke-mainColor text-secondColor dark:text-stroke-secondColor dark:text-mainColor">
            de cerises
          </span>
          <span ref={ref4} className="translate-y-full opacity-0 text-mainColor dark:text-secondColor">
            griottes
          </span>
        </p>
        <p className="flex gap-4 mt-12 overflow-hidden text-3xl sm:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl">
          <span ref={ref5} className="translate-y-full opacity-0 text-mainColor dark:text-secondColor">
            et toujours
          </span>
          <span ref={ref6} className="translate-y-full opacity-0 text-stroke-1 text-stroke-mainColor text-secondColor dark:text-secondColor dark:text-stroke-secondColor">
            aussi
          </span>
        </p>

        <p className="flex gap-8 mt-2 overflow-hidden text-3xl sm:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl">
          <span ref={ref7} className="translate-y-full opacity-0 text-mainColor dark:text-secondColor">
            rafraichissant
          </span>
        </p>
      </div>
