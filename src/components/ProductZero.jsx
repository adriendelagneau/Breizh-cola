    ...
    <BreizhZero />
      ...
      <div className="flex flex-col gap-12 ml-3 text-3xl uppercase sm:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-poppins">
        <p className="flex gap-4 overflow-hidden">
          <span ref={refZero1} className="translate-y-full opacity-0 text-mainColor dark:text-secondColor">
            0%
          </span>
          <span ref={refZero2} className="overflow-hidden translate-y-full opacity-0 text-stroke-1 text-stroke-mainColor text-secondColor dark:text-mainColor dark:text-stroke-secondColor">
            Sucres
          </span>
        </p>
        <p className="flex gap-1 overflow-hidden">
          <span ref={refZero3} className="translate-y-full opacity-0 text-stroke-1 text-stroke-mainColor text-secondColor dark:text-stroke-secondColor dark:text-mainColor">
            Un gout
          </span>
          <span ref={refZero4} className="translate-y-full opacity-0 text-mainColor dark:text-secondColor">
            intense
          </span>
        </p>
        <p className="flex gap-4 mt-12 overflow-hidden text-3xl sm:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl">
          <span ref={refZero5} className="translate-y-full opacity-0 text-mainColor dark:text-secondColor">
            Zero 
          </span>
          <span ref={refZero6} className="translate-y-full opacity-0 text-stroke-1 text-stroke-mainColor text-secondColor dark:text-secondColor dark:text-stroke-secondColor">
            Calories
          </span>
        </p>

        <p className="flex gap-8 mt-2 overflow-hidden text-3xl sm:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl">
          <span ref={refZero7} className="translate-y-full opacity-0 text-mainColor dark:text-secondColor">
            100% plaisir
          </span>
        </p>
      </div>
