...
import "./styles.css";
console.clear();
// This line is needed just here, in your project use the regular
// import statement.
// Flip plugin is a GSAP Club plugin, follow the instructions
// in the docs to install it properly:
