...
const SingleInfos = ({infos}) => {
  ...
  return (
    ...
    <div id='singleInfos' ref={container} className="flex flex-col items-center justify-center w-full gap-12 p-10 mx-auto my-12 text-xl font-extrabold dark:text-mainColor text-secondColor sm:text-2xl lg:text-4xl font-poppins max-w-screen-2xl">
      {infos.map((phrase, index) => (
