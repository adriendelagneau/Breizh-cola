...
import { useMeshStore } from '@/hooks/useZuStore'
        ...
        <div className='w-full relative'>
            ...
            <div className='hero'>
                <div
                    ref={landingRef}
                    id="landing"
                    className="relative flex flex-col items-center w-full h-screen p-4 pt-32 overflow-hidden uppercase font-poppins bg-secondColor  text-mainColor lg:justify-center lg:items-start 2xl:pl-24"
                >
                    ...
                    <div className="flex pt-12 overflow-hidden -skew-y-3">
                        ...
                        <div
                            ref={title4Ref}
                            className="inline text-5xl translate-y-full   sm:text-6xl lg:text-8xl text-stroke-1 text-stroke-mainColor text-secondColor   xl:text-[170px] md:text-7xl"
                        >
                            cola
                        </div>
                        <div
                ...
                <div className='w-full min-h-screen bg-secondColor'>two</div>
            </div>
        </div>
    )
}
