...
const ProductIntro = (props: Props) => {
  ...
  return (
    <div className='min-h-screen w-full text-7xl p-24 font-poppins text-secondColor leading-loose relative z-50 bg-gradient-custom uppercase'>

 
    <div ref={container} className="flex flex-col items-center justify-center w-full gap-12 p-10 mx-auto my-12  text-secondColor text-6xl font-poppins max-w-screen-2xl">
