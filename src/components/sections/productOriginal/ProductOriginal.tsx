...
const ProductOriginal = () => {
  ...
  return (
    <div
      className="relative top-0 left-0 flex flex-col items-center w-full min-h-screen xl:items-start xl:pl-6  overflow-hidden product-original"
      ref={screenRef}
    >
