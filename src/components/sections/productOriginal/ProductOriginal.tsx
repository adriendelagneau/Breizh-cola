...
const ProductOriginal = () => {
    ...
    return (
        <div className="relative top-0 left-0 flex flex-col items-center w-full min-h-screen xl:items-start xl:pl-6 bg-secondColor overflow-hidden product-original" ref={screenRef}>
        ...
        <Scene flavor='original' />
            ...
            <div className="flex flex-col gap-12 ml-3 text-3xl uppercase sm:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-poppins">
                <p className="flex gap-4 overflow-hidden">
                    ...
                    <span
                        ref={ref2}
                        className="overflow-hidden  text-stroke-1 text-stroke-mainColor text-secondColor  "
                    >
                        originale
                    </span>
                </p>
                <p className="flex gap-1 overflow-hidden">
                    <span
                        ref={ref3}
                        className=" text-stroke-1 text-stroke-mainColor text-secondColor  "
                    >
                        Son
                    </span>
                    <span ref={ref4} className="overflow-hidden  text-mainColor ">
                        secret ?
                    </span>
                </p>
