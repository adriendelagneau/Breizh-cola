...
const ProductZero = () => {
  ...
  return (
    <div
      ref={sectionZeroRef}
      className="product-zero relative top-0 left-0 flex min-h-screen w-full flex-col items-center overflow-hidden xl:items-start xl:pl-6"
    >
