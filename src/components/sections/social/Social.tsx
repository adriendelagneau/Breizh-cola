...
const Social = (props: Props) => {
  ...
  return (
    <div ref={containerRef} className='h-screen w-full bg-secondColor relative overflow-hidden flex items-center justify-center'>

<p className="font-poppins text-mainColor text-6xl sm:text-7xl md:text-8xl uppercase -skew-y-3 ">
  restez connectez
</p>
