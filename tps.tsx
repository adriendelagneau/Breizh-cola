...
const SideMenu = () => {
  ...
  return (
    <div
      ref={menuRef}
      className="bg-primary fixed top-20 left-0 z-20 flex h-[calc(100vh-5rem)] w-full transform items-center justify-center translate-x-[100%]"
      role="dialog"
      aria-hidden={!isMenuOpen}
    >
      <ul className="text-secondary flex flex-col items-center gap-6 text-7xl uppercase font-poppins">
